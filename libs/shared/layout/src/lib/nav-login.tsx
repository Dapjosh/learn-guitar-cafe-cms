...
export function NavLogin({
  ...
  return (
    <>
      ...
      <div
        className={
          'grid grow-0 grid-cols-2 items-center justify-center md:hidden'
        }
      >
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger
            ...
            className={
              'absolute right-0 top-1/2 z-50 block -translate-y-1/2 items-center md:hidden'
            }
          >
          ...
          <SheetContent
            id="mobile-menu"
            side={'right'}
            className={'z[999] w-[80vw] px-0 pb-0'}
          >
            <SheetHeader>
            ...
            <div className={'flex h-full flex-col items-stretch'}>
              <div className={'grow'}>
                ...
                <ul
                  className={
                    'b mt-10 flex flex-col divide-y divide-gray-500/10'
                  }
                >
                  {navigation?.links &&

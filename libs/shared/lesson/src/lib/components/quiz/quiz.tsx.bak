'use client';
import { SectionCourse, SectionLesson, SectionModule } from '@lgc_cms/types';
...
import { usePointsStore } from '@lgc_cms/providers';
import gsap from 'gsap';
import { useGSAP } from '@gsap/react';
import { useConfettiStore } from '@lgc_cms/hooks';

...
import { Button, buttonVariants } from '@lgc_cms/shadcn-ui/server';
import { ChevronRightIcon, MenuIcon } from 'lucide-react';
import Link from 'next/link';
import cn from 'classnames';
import Image from 'next/image';
import ButtonDownloadPdf from '../button-download-pdf';
import { useCourseProgressionStore } from '@lgc_cms/providers';
import { useClientMediaQuery } from '@lgc_cms/hooks';

...
interface CourseDocumentData {
  ...
  /**
   * Course Image field in *Course*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: course.course_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  ...
  /**
   * Summary field in *Course*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course.summary
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
   ...
   * - **Documentation**: https://prismic.io/docs/fields/content-relationship
   */
  course_category: ContentRelationshipFieldWithData<
    [{ id: "course_category"; fields: ["name"] }]
  >;

  /**
   * author field in *Course*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course.author
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * duration field in *Course*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course.duration
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  ...
  /**
   * student_count field in *Course*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: course.student_count
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
  student_count: prismic.NumberField;

  /**
   * original_price field in *Course*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: course.original_price
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
  ...
  /**
   * current_price field in *Course*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: course.current_price
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
...
/**
 * Content for Course Category documents
 */
interface CourseCategoryDocumentData {
  /**
   * name field in *Course Category*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_category.name
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  name: prismic.KeyTextField;
...
/**
 * Course Category document from Prismic
 *
 * - **API ID**: `course_category`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/content-modeling
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type CourseCategoryDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<CourseCategoryDocumentData>,
    "course_category",
    Lang
  >;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type OnboardingDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<
...
interface SettingsDocumentData {
   ...
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  contact_form_enquiries: prismic.GroupField<
    Simplify<SettingsDocumentDataContactFormEnquiriesItem>
  >;
...
export interface CallToActionSliceDefaultPrimary {
  ...
  buttons: prismic.GroupField<
    Simplify<CallToActionSliceDefaultPrimaryButtonsItem>
  >;
}
...
export interface CallToActionSliceImagePrimary {
   ...
   */
  buttons: prismic.GroupField<
    Simplify<CallToActionSliceImagePrimaryButtonsItem>
  >;
...
export interface CallToActionSliceCenterPrimary {
   ...
   */
  buttons: prismic.GroupField<
    Simplify<CallToActionSliceCenterPrimaryButtonsItem>
  >;
...
export interface CallToActionSliceTextTwoColumnPrimary {
   ...
   */
  buttons: prismic.GroupField<
    Simplify<CallToActionSliceTextTwoColumnPrimaryButtonsItem>
  >;
}
...
export interface ContentImageSliceSliceSectionContentImagePrimary {
  ...
  items: prismic.GroupField<
    Simplify<ContentImageSliceSliceSectionContentImagePrimaryItemsItem>
  >;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentImageSliceSliceSectionContentImage =
 ...
 */
type ContentImageSliceSliceVariation =
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContentImageSliceSlice = prismic.SharedSlice<
  "content_image_slice",
  ContentImageSliceSliceVariation
>;

/**
 * Item in *CourseGrid → Default → Primary → Courses*
 */
export interface CourseGridSliceDefaultPrimaryCoursesItem {
  /**
   * Course Category field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].course_category
   * - **Documentation**: https://prismic.io/docs/fields/content-relationship
   */
  course_category: ContentRelationshipFieldWithData<
    [{ id: "course_category"; fields: ["name"] }]
  ...
  /**
   * Course Image field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].course_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  course_image: prismic.ImageField<never>;

  /**
   * Instructor field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].instructor
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  instructor: prismic.KeyTextField;

  /**
   * Course Title field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].course_title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  course_title: prismic.RichTextField;

  /**
   * Duration field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].duration
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  duration: prismic.KeyTextField;

  /**
   * Students Count field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Number
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].students_count
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
  students_count: prismic.NumberField;

  /**
   * Original Price field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].original_price
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  original_price: prismic.KeyTextField;

  /**
   * Current Price field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].current_price
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  current_price: prismic.KeyTextField;

  /**
   * Course CTA Link field in *CourseGrid → Default → Primary → Courses*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[].cta_link
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
...
/**
 * Primary content in *CourseGrid → Default → Primary*
 */
export interface CourseGridSliceDefaultPrimary {
  /**
   * Section Title field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.section_title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  section_title: prismic.RichTextField;

  /**
   * Section Description field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.section_description
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  section_description: prismic.RichTextField;

  /**
   * All Courses Link field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.all_courses_link
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  all_courses_link: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
  ...
  /**
   * button_text field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.button_text
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  button_text: prismic.KeyTextField;

  /**
   * Courses field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.courses[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  courses: prismic.GroupField<
    Simplify<CourseGridSliceDefaultPrimaryCoursesItem>
  >;

  /**
   * Show Card Shadow field in *CourseGrid → Default → Primary*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **API ID Path**: course_grid.default.primary.show_shadow
   * - **Documentation**: https://prismic.io/docs/fields/boolean
   */
...
/**
 * Default variation for CourseGrid Slice
 *
 * - **API ID**: `default`
 * - **Description**: Standard grid of multiple featured courses with consistent fields for each item.
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CourseGridSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<CourseGridSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *CourseGrid*
 */
type CourseGridSliceVariation = CourseGridSliceDefault;

/**
 * CourseGrid Shared Slice
 *
 * - **API ID**: `course_grid`
 * - **Description**: *None*
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CourseGridSlice = prismic.SharedSlice<
  "course_grid",
  CourseGridSliceVariation
>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FeaturesSliceWhite = prismic.SharedSliceVariation<
  "white",
  Simplify<FeaturesSliceWhitePrimary>,
  never
>;
...
export interface HeroSliceThunderDecorationPrimary {
   ...
   */
  buttons: prismic.GroupField<
    Simplify<HeroSliceThunderDecorationPrimaryButtonsItem>
  >;
}
...
/**
 * Primary content in *HeroHeading → Default → Primary*
 */
export interface HeroHeadingSliceDefaultPrimary {
  /**
   * Title field in *HeroHeading → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_heading.default.primary.title
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  title: prismic.RichTextField;

  /**
   * Description field in *HeroHeading → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_heading.default.primary.description
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  description: prismic.RichTextField;

  /**
   * Background Image field in *HeroHeading → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_heading.default.primary.background_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  background_image: prismic.ImageField<never>;

  /**
   * Font Size field in *HeroHeading → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: Adjust font size
   * - **API ID Path**: hero_heading.default.primary.font_size
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  font_size: prismic.SelectField<"Small" | "Medium" | "Large" | "Extra Large">;

  /**
   * Background Opacity field in *HeroHeading → Default → Primary*
   *
   * - **Field Type**: Number
   * - **Placeholder**: Enter a value between 0 and 100
   * - **API ID Path**: hero_heading.default.primary.background_opacity
   * - **Documentation**: https://prismic.io/docs/fields/number
   */
...
export interface ImageGallerySliceDefaultPrimary {
  ...
  /**
   * Padding field in *ImageGallery → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: image_gallery.default.primary.padding
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  padding: prismic.SelectField<"None" | "Small" | "Medium" | "Large">;

  /**
   * Background Color field in *ImageGallery → Default → Primary*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: image_gallery.default.primary.background_color
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type LessonRickTextSliceTwoColumnsWithHeader =
  prismic.SharedSliceVariation<
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type LessonRickTextSlice = prismic.SharedSlice<
  "lesson_rick_text",
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type RichTextSliceSliceTwoColumnsWithHeader =
  prismic.SharedSliceVariation<
    "twoColumnsWithHeader",
...
export interface SectionHeadersSliceWithButtonsPrimary {
   ...
   */
  buttons: prismic.GroupField<
    Simplify<SectionHeadersSliceWithButtonsPrimaryButtonsItem>
  >;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionHeadersSlice = prismic.SharedSlice<
  "section_headers",
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ContentImageSliceSliceSectionContentImage,
      CourseGridSlice,
      CourseGridSliceDefaultPrimaryCoursesItem,
      CourseGridSliceDefaultPrimary,
      CourseGridSliceVariation,
      CourseGridSliceDefault,
      FaqsSlice,
